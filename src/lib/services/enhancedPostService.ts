...
function createFallbackPostsWithMediaUrls(fallbacks: Array<{ id: string; title: string }>): (WordPressPost & { mediaUrl: string | null; mediaDimensions: { width: number; height: number } | null })[] {
