...
export const MIDDLEWARE_RATE_LIMIT = {
  MAX_REQUESTS: parseInt(process.env.MIDDLEWARE_RATE_LIMIT_MAX_REQUESTS || '60', 10),
  WINDOW_SECONDS: parseInt(process.env.MIDDLEWARE_RATE_LIMIT_WINDOW_SECONDS || '60', 10),
} as const
