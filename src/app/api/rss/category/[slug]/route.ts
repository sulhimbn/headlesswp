...
async function rssCategoryHandler(_request: NextRequest, context?: unknown) {
  try {
    const params = context as { params: Promise<{ slug: string }> } | undefined
...
export const GET = withApiRateLimit(rssCategoryHandler, 'rss')
