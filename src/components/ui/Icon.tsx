...
export type IconType = 'facebook' | 'twitter' | 'instagram' | 'close' | 'menu' | 'search' | 'loading' | 'sun' | 'moon' | 'bookmark' | 'bookmarkOutline'
...
function IconComponent({ type, className, 'aria-hidden': ariaHidden = true }: IconProps) {
  ...
  switch (type) {
    ...
    case 'loading':
      return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" role="status" aria-live="polite" aria-label={UI_TEXT.icon.loading}>
