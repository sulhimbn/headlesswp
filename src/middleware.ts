...
function setPermissionsPolicyHeaders(response: NextResponse): void {
...
function setCrossOriginIsolationHeaders(response: NextResponse): void {
...
export function middleware(request: NextRequest) {
  ...
  setPermissionsPolicyHeaders(response)
