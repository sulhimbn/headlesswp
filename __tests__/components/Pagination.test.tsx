...
describe('Pagination Component', () => {
  ...
  describe('Rendering - Basic Cases', () => {
    test('renders navigation element', () => {
      ...
      const nav = screen.getByRole('navigation', { name: UI_TEXT.pagination.ariaLabel })
    ...
    test('renders all pages when totalPages <= MAX_VISIBLE_PAGES', () => {
      ...
      for (let i = 1; i <= 5; i++) {
        expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} ${i}` })).toBeInTheDocument()
      }
    })
  })
  ...
  describe('Previous Button', () => {
    test('shows previous button when not on first page', () => {
      render(<Pagination currentPage={2} totalPages={5} basePath={basePath} />)
      const prevButton = screen.getByRole('link', { name: UI_TEXT.pagination.previousPage })
      expect(prevButton).toBeInTheDocument()
    })

    test('does not show previous button on first page', () => {
      render(<Pagination currentPage={1} totalPages={5} basePath={basePath} />)
      const prevButton = screen.queryByRole('link', { name: UI_TEXT.pagination.previousPage })
    ...
    test('previous button has correct aria-label', () => {
      render(<Pagination currentPage={2} totalPages={5} basePath={basePath} />)
      const prevButton = screen.getByRole('link', { name: UI_TEXT.pagination.previousPage })
      expect(prevButton).toHaveAccessibleName(UI_TEXT.pagination.previousPage)
    })
  })
  ...
  describe('Next Button', () => {
    test('shows next button when not on last page', () => {
      render(<Pagination currentPage={2} totalPages={5} basePath={basePath} />)
      const nextButton = screen.getByRole('link', { name: UI_TEXT.pagination.nextPage })
      expect(nextButton).toBeInTheDocument()
    })

    test('does not show next button on last page', () => {
      render(<Pagination currentPage={5} totalPages={5} basePath={basePath} />)
      const nextButton = screen.queryByRole('link', { name: UI_TEXT.pagination.nextPage })
    ...
    test('next button has correct aria-label', () => {
      render(<Pagination currentPage={2} totalPages={5} basePath={basePath} />)
      const nextButton = screen.getByRole('link', { name: UI_TEXT.pagination.nextPage })
      expect(nextButton).toHaveAccessibleName(UI_TEXT.pagination.nextPage)
    })
  })
  ...
  describe('Page Links', () => {
    ...
    test('non-current pages have inactive styling', () => {
      render(<Pagination currentPage={3} totalPages={5} basePath={basePath} />)
      const otherPageLink = screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 1` })
  ...
  describe('Edge Cases - First Page', () => {
    test('first page shows correct pagination', () => {
      ...
      expect(screen.queryByRole('link', { name: UI_TEXT.pagination.previousPage })).not.toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 1` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 2` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 3` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 4` })).toBeInTheDocument()
      expect(screen.getByText('...')).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 10` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: UI_TEXT.pagination.nextPage })).toBeInTheDocument()
    })

    test('first page has aria-current on page 1', () => {
      render(<Pagination currentPage={1} totalPages={10} basePath={basePath} />)
      const page1 = screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 1` })
  ...
  describe('Edge Cases - Last Page', () => {
    test('last page shows correct pagination', () => {
      ...
      expect(screen.getByRole('link', { name: UI_TEXT.pagination.previousPage })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 1` })).toBeInTheDocument()
      expect(screen.getByText('...')).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 7` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 8` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 9` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 10` })).toBeInTheDocument()
      expect(screen.queryByRole('link', { name: UI_TEXT.pagination.nextPage })).not.toBeInTheDocument()
    })

    test('last page has aria-current on page 10', () => {
      render(<Pagination currentPage={10} totalPages={10} basePath={basePath} />)
      const page10 = screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 10` })
  ...
  describe('Edge Cases - Middle Pages', () => {
    test('middle page shows correct pagination', () => {
      ...
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 4` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 5` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 6` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 10` })).toBeInTheDocument()
    })
  })
  ...
  describe('Design Tokens', () => {
    ...
    test('uses design tokens for border radius', () => {
      render(<Pagination currentPage={3} totalPages={5} basePath={basePath} />)
      const pageLink = screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 3` })
  ...
  describe('Accessibility', () => {
    test('nav element has correct aria-label', () => {
      render(<Pagination currentPage={3} totalPages={5} basePath={basePath} />)
      const nav = screen.getByRole('navigation', { name: UI_TEXT.pagination.ariaLabel })
      expect(nav).toHaveAccessibleName(UI_TEXT.pagination.ariaLabel)
    })

    test('page links have correct aria-label', () => {
      render(<Pagination currentPage={3} totalPages={5} basePath={basePath} />)
      const pageLink = screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 3` })
      expect(pageLink).toHaveAccessibleName(`${UI_TEXT.pagination.page} 3`)
    })
  ...
  describe('Edge Cases - Extreme Values', () => {
    ...
    test('handles very large totalPages', () => {
      ...
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 50` })).toBeInTheDocument()
      expect(screen.getByRole('link', { name: `${UI_TEXT.pagination.page} 100` })).toBeInTheDocument()
      expect(screen.getAllByText('...')).toHaveLength(2)
    })
  })
})
